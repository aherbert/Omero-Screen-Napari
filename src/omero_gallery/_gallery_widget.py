...
def gallery_widget(
    ...
    show_gallery(crop_size, rows, columns, contour)


def show_gallery(crop_size, rows, columns, contour):
    images = scale_img(viewer_data.images[..., [3, 1, 0]])
    cropped_regions, cropped_labels = generate_crops(
